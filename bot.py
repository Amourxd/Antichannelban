...
check /help for more.""",
                             reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Bots Channel", url=f"https://t.me/op_arnav_singh"),
                                                                 InlineKeyboardButton("Support Group", url=f"https://t.me/link_copied")]]),
...
for more help ask at @cute_arnavsingh""",
                             reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Bots Channel", url=f"https://t.me/op_arnav_singh"),
                                                                 InlineKeyboardButton("Support Group", url=f"https://t.me/link_copied")]]),
                             disable_web_page_preview=True)
